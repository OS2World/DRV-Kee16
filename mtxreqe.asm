...
;VOID APIENTRY KernRequestExclusiveMutex16(MutexLock_t _far *pMutexLock)
KernRequestExclusiveMutex16 PROC FAR PASCAL PUBLIC
       push bp
       mov  bp,sp
...
label16 LABEL FAR16
       ...
       pop bp
       retf 4
KernRequestExclusiveMutex16 ENDP
...
EXTRN  SYSCALL KernRequestExclusiveMutex:PROC 
...
label32 LABEL FAR32
       ...
       call KernSelToFlat
       mov  [esp],eax
       call KernRequestExclusiveMutex
       add  esp,4
