...
;VOID APIENTRY KernReleaseSpinLock16 (SpinLock_t _far *pSpinLock);
KernReleaseSpinLock16 PROC FAR PASCAL PUBLIC
       push bp
       mov  bp,sp
...
EXTRN  SYSCALL KernReleaseSpinLock:PROC
