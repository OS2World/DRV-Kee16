...
;VOID APIENTRY KernFreeSpinLock16 (SpinLock_t _far *pSpinLock);
KernFreeSpinLock16 PROC FAR PASCAL PUBLIC
       push bp
       mov  bp,sp
...
EXTRN  SYSCALL KernFreeSpinLock:PROC
...
label32 LABEL FAR32
       ...
       push DWORD PTR [ebp+6]           ; pSpinLock
       call KernSelToFlat
       mov  [esp],eax
       call KernFreeSpinLock
       add  esp,4
