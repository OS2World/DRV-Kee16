...
;VOID APIENTRY KernReleaseExclusiveMutex16(MutexLock_t _far *pMutexLock)
KernReleaseExclusiveMutex16 PROC FAR PASCAL PUBLIC
       push bp
       mov  bp,sp
...
label16 LABEL FAR16
       ...
       pop bp
       retf 4
KernReleaseExclusiveMutex16 ENDP
...
EXTRN  SYSCALL KernReleaseExclusiveMutex:PROC 
...
label32 LABEL FAR32
       ...
       call KernSelToFlat
       mov  [esp],eax
       call KernReleaseExclusiveMutex
       add  esp,4
