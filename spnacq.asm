...
;VOID APIENTRY KernAcquireSpinLock16 (SpinLock_t _far *pSpinLock);
KernAcquireSpinLock16 PROC FAR PASCAL PUBLIC
       push bp
       mov  bp,sp
...
EXTRN  SYSCALL KernAcquireSpinLock:PROC
