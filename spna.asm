...
;VOID APIENTRY KernAllocSpinLock16 (SpinLock_t _far *pSpinLock);
KernAllocSpinLock16 PROC FAR PASCAL PUBLIC
       push bp
       mov  bp,sp
...
EXTRN  SYSCALL KernAllocSpinLock:PROC
