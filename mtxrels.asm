...
;VOID APIENTRY KernReleaseSharedMutex16(MutexLock_t _far *pMutexLock)
KernReleaseSharedMutex16 PROC FAR PASCAL PUBLIC
       push bp
       mov  bp,sp
...
EXTRN  SYSCALL KernReleaseSharedMutex:PROC 
