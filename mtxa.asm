...
;VOID APIENTRY KernAllocMutexLock16 (MutexLock_t _far *pMutexLock);
KernAllocMutexLock16 PROC FAR PASCAL PUBLIC
       push bp
       mov  bp,sp
...
EXTRN  SYSCALL KernAllocMutexLock:PROC
