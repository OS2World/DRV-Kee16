...
;VOID APIENTRY KernFreeMutexLock16(MutexLock_t _far *pMutexLock)
KernFreeMutexLock16 PROC FAR PASCAL PUBLIC
       push bp
       mov  bp,sp
...
EXTRN  SYSCALL KernFreeMutexLock:PROC
