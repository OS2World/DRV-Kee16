...
;BOOL _pascal KernTryRequestSharedMutex16(MutexLock_t _far *pMutexLock)
KernTryRequestSharedMutex16 PROC FAR PASCAL PUBLIC
       push bp
       mov  bp,sp
...
label16 LABEL FAR16
       ...
       pop bp
       ret 4
KernTryRequestSharedMutex16 ENDP
...
EXTRN  SYSCALL KernTryRequestSharedMutex:PROC 
...
label32 LABEL FAR32
       ...
       call KernSelToFlat
       mov  [esp],eax
       call KernTryRequestSharedMutex
       add  esp,4
